  ...
  <body id="page-top">
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">Balance
            <span class="text-primary">PET</span>
          </h1>
          <div class="subheading mb-5">비트교육센터 서울시 서초구 서초동 1327-15 비트아카데미빌딩 501호 (02) 3486-9600
            <a href="mailto:name@email.com">angelpjn@gmail.com</a>
          </div>
          <p class="mb-5">애견 종합 솔루션 Balance Pet을 방문해주셔서 감사합니다.</p>
        ...
        <div class="my-auto">
          <h2 class="mb-5">
            <ul class='navbar-nav mr-auto'>
			  <li class='nav-item'>
			    <a class='nav-link' href='../pet/list'>PET CARE</a>
			  </li>
			</ul>
          </h2>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
        <div class="my-auto">
          <h2 class="mb-5">
            <ul class='navbar-nav mr-auto'>
              <li class='nav-item'>
                <a class='nav-link' href='../business/list'>PET TOGETHER</a>
              </li>
            </ul>
          </h2>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="interests">
        <div class="my-auto">
          <h2 class="mb-5">
            <ul class='navbar-nav mr-auto'>
              <li class='nav-item'>
                <a class='nav-link' href='../pet/list'>PET CAST</a>
              </li>
            </ul>
          </h2>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="awards">
        <div class="my-auto">
          <h2 class="mb-5">
            <ul class='navbar-nav mr-auto'>
              <li class='nav-item'>
                <a class='nav-link' href='../lost/list'>LOST</a>
              </li>
            </ul>
          </h2>
          <ul class="fa-ul mb-0">
