...
<form action='update' method='post' enctype="multipart/form-data">
		...
		<div class='col-sm-10'>
		<input class='form-control' readonly id='category' type='text' name='category'
		...
		<div class='col-sm-10'>
		<input class='form-control' readonly id='businessName' type='text' name='businessName'
		...
		<div class='col-sm-10'>
		<input class='form-control' readonly id='open_time' type='time' name='open_time'
		...
		<div class='col-sm-10'>
		<input class='form-control' readonly id='close_time' type='time' name='close_time'
		...
		<div class='col-sm-10'>
		<input class='form-control' readonly id='tel' type='text' name='tel'
		          value='${business.tel}'>
		</div>
		</div>
		...
		<div class='col-sm-10'>
		<input class='form-control' readonly id='menu' type='text' name='menu'
		          value='${business.menu}'>
		</div>
		</div>
		...
		<div class='col-sm-10'>
		<input class='form-control' readonly id='content' type='text' name='content'
		...
		<div class='col-sm-10'>
		<input class='form-control' readonly id='post_no' type="number" name='post_no'
		...
		<div class='col-sm-10'>
		<input class='form-control' readonly id='primary_address' type='text' name='primary_address'
		...
		<div class='col-sm-10'>
		<input class='form-control' readonly id='detail_address' type='text' name='detail_address'
        ...
        <div class='col-sm-10'>
        <input type="file" class="form-control-file"  readonly id="file2" name="file">
        </div>
        </div>
        
        <div class='form-group row'>
        <div class='col-sm-10'>
        <button class='btn btn-primary btn-sm'>뒤로</button>
        <a href='modify?bus_no=${business.businessNo}' class='btn btn-primary btn-sm'>수정</a>
        </div>
        </div>
</form>
</td>
