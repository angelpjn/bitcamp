...
package solve_original.solve_jungseok.ch11_Collections_Framework;
...
class Exercise11_8 {
    public static void calculateSchoolRank(List list) {
         ...
         * 서로 다르면, 등수(schoolRank)의 값을 알맞게 계산해서 저장한다. 이전에 동점자 였다면, 그 다음 등수는 동점자의 수를 고려해야
         * 한다. (실행결과 참고) 1.3 현재 총점과 등수를 이전총점(prevTotal)과 이전등수(prevRank)에 저장한다.
         */
    }
