...
public class ScoreAddServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<div class='col-sm-10'>");
        out.println("<input class='form-control form-control-sm' id='kor' type='number' name='kor'>");
        out.println("</div>");
        out.println("</div>");
        ...
        out.println("<div class='col-sm-10'>");
        out.println("<input class='form-control form-control-sm' id='eng' type='number' name='eng'>");
        out.println("</div>");
        out.println("</div>");
        ...
        out.println("<div class='col-sm-10'>");
        out.printf("<input class='form-control form-control-sm' id='math' type='number' name='math'>");
        out.println("</div>");
        out.println("</div>");
