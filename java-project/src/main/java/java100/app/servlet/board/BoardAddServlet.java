...
public class BoardAddServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<input class='form-control form-control-sm' id='title' type='text' name='title'>\n");
        out.println("</div>");
        out.println("</div>");
        ...
        out.println("<div class='col-sm-10'>");
        out.println("<input class='form-control form-control-sm' id='content' type='text' name='content'>\n"); 
        out.println("</div>");
        out.println("</div>");
