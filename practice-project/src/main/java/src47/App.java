...
import src47.beans.ApplicationContext;
import src47.control.Controller;
import src47.control.Request;
import src47.control.Response;
import src47.util.DataSource;
...
public class App {
    ...
    void init() {
        beanContainer = new ApplicationContext("src47");
